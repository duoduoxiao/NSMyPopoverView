...
- (id)initWithContentView:(UIView *)contentView
{
    ...
    if(self){
        ...
        super.hidden            = YES;
        self.backgroundColor    = [UIColor colorWithWhite:0/255.0 alpha:0.5f];
...
- (void)showInView:(UIView *)view animated:(BOOL)animated completedBlock:(void(^)())completedBlock
{
    ...
    //更新毛玻璃效果
    UIWindow * basedWindow = [view isKindOfClass:[UIWindow class]] ? (UIWindow *)view : (view.window ?: ([UIApplication sharedApplication].delegate).window);
...
- (void)defaultPushCustomAnimationForPopoverView:(MyPopoverView *)popoverView
                                       direction:(MyMoveAnimtedDirection)direction
                                            show:(BOOL)show
                                  animationBlock:(void(^)())animationBlock
                                  completedBlock:(void(^)())completedBlock
{
    ...
    switch (direction) {
        case MyMoveAnimtedDirectionDown:
        ...
        case MyMoveAnimtedDirectionLeft:
        ...
        case MyMoveAnimtedDirectionRight:
